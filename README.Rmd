...
play around with simple blind source separation examples with images.   see results via [this link](https://stnava.github.io/blindSourceSeparationInANTsR/)
...
cc   = compcor( bmat, 20, variance_extreme = 0.1 )
...
```{r boldEanat,eval=TRUE}
sparsenessParam = (range( abs( bica$S ) ) * 0.00001 )[ 2 ] 
eanat<-eanatDef( 
    inmat      = scale( rbmat ),
    mask       = bmsk, 
    smoother   = 1.0,
